...
//		assertEquals(0.331, regressionRandom.getCorrelation(), 0.001);
...
//		assertEquals(62.18, regressionRandom.getRegressionCoeff(), 0.001);
...
//		assertEquals(-369.416, regressionRandom.getRegressionOffset(), 0.001);
